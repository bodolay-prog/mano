...
func init(parent: Character, animations_player: AnimationPlayer, node_hitbox_manager: hitbox_manager, node_hurtbox_manager: hurtbox_manager, input_component) -> void:
