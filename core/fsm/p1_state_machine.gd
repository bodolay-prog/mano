class_name state_machine_p1
extends Node

@export
var starting_state: P1State
var old_state: P1State
var current_state: P1State

# Initialize the state machine by giving each child state a reference to the
# parent object it belongs to and enter the default starting_state.
func init(parent: P1Character, animations_player: AnimationPlayer, node_hitbox_manager: hitbox_manager, node_hurtbox_manager: hurtbox_manager, input_component) -> void:
...
func change_state(new_state: P1State) -> void:
