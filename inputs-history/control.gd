...
func _draw() -> void:
	...
	draw_trigger(Vector2(52, 5), Input.is_action_pressed("p1_dash")) # dash
	...
	draw_dpad_arrow(dpad_position + Vector2(1, 8), deg_to_rad(-90), Input.is_action_pressed("p1_left")) # esquerda
	draw_dpad_arrow(dpad_position + Vector2(8, 1), deg_to_rad(0), Input.is_action_pressed("p1_up")) #cima
	draw_dpad_arrow(dpad_position + Vector2(15, 8), deg_to_rad(90), Input.is_action_pressed("p1_right")) # direita
	draw_dpad_arrow(dpad_position + Vector2(8, 15), deg_to_rad(180), Input.is_action_pressed("p1_down")) # baixo
	...
	draw_face_button(face_buttons_position + Vector2(1, 9), Input.is_action_pressed("p1_L")) # leve
	draw_face_button(face_buttons_position + Vector2(9, 1), Input.is_action_pressed("p1_M")) # medio
	draw_face_button(face_buttons_position + Vector2(17, 9), Input.is_action_pressed("p1_H")) # pesado
	draw_face_button(face_buttons_position + Vector2(9, 17), Input.is_action_pressed("p1_S")) # special
	
	draw_option_button(Vector2(33, 27), Input.is_action_pressed("p1_back")) # back
	draw_option_button(Vector2(42, 27), Input.is_action_pressed("p1_start")) # start
