...
@export
var _5_jL_P2State: P2State
@export
var _5_jM_P2State: P2State
@export
var _5_jH_P2State: P2State
...
func process_physics(delta: float) -> P2State:
	...
	if !parent.is_on_floor():
		...
		if action_input_handler() == 'L':
			return _5_jL_P2State
		if action_input_handler() == 'M':
			return _5_jM_P2State
		if action_input_handler() == 'H':
			return _5_jH_P2State
