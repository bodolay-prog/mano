...
func enter() -> void:
	if state_machine_path.old_state == _2_L_P2State or state_machine_path.old_state == _2_M_P2State or state_machine_path.old_state == _2_H_P2State or state_machine_path.old_state == crouch_state:
